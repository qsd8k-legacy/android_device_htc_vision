...
static const struct sensor_t sSensorList[] = {
    { "BMA150 3-axis Accelerometer",
      ...
      "android.sensor.accelerometer", NULL, 0, SENSOR_FLAG_CONTINUOUS_MODE, { } },
    { "AK8975 3-axis Magnetic field sensor",
      "Asahi Kasei",
      1, SENSORS_HANDLE_BASE + ID_M,
      SENSOR_TYPE_MAGNETIC_FIELD, 2000.0f, 1.0f / 16.0f, 6.8f, 0, 0, 0,
      "android.sensor.magnetic_field", NULL, 0, SENSOR_FLAG_CONTINUOUS_MODE, { } },
    { "AK8975 Orientation sensor",
      "Asahi Kasei",
      1, SENSORS_HANDLE_BASE + ID_O,
      SENSOR_TYPE_ORIENTATION, 360.0f, 1.0f, 7.0f, 0, 0, 0,
      "android.sensor.orientation", NULL, 0, SENSOR_FLAG_CONTINUOUS_MODE, { } },
    { "CM3602 Proximity sensor",
      ...
      0.5f, 0, 0, 0,
      "android.sensor.proximity", NULL, 0, SENSOR_FLAG_ON_CHANGE_MODE, { } },
    { "CM3602 Light sensor",
      "Capella Microsystems",
      1, SENSORS_HANDLE_BASE + ID_L,
      SENSOR_TYPE_LIGHT, 1023.0f, 1.0f, 0.5f, 0, 0, 0,
      "android.sensor.light", NULL, 0, SENSOR_FLAG_CONTINUOUS_MODE, { } },
};
